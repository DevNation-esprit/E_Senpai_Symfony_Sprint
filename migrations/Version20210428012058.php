 ...
 */
final class Version20210428012058 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE test ADD nom VARCHAR(255) NOT NULL, ADD prenom INT NOT NULL, CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE id_formateur id_formateur INT DEFAULT NULL, CHANGE id_formation id_formation INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE test DROP nom, DROP prenom, CHANGE id id INT NOT NULL, CHANGE id_formation id_formation INT NOT NULL, CHANGE id_formateur id_formateur INT NOT NULL');
